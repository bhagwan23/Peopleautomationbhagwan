...
public class HomePage {
	...
	public void enterOrgDetails(String taxresidency, String fstartdate, String bookbeginningdate, String addline1,
	...
	public void clickAccountingTab() {
        ...
        wait.until(ExpectedConditions.elementToBeClickable(accountingTab));
		accountingTab.click();
	}
	...
	public void clickSettingTab() throws InterruptedException {
		...
		/*
		 * Actions action = new Actions(driver); WebElement settings =
		 * driver.findElement(By.xpath("//span[contains(.,'Settings')]"));
		 * action.moveToElement(settings).perform();
		 */

		/*
		 * Actions builder = new Actions(driver); Action mouseOverSettings =
		 * builder .moveToElement(settingTab) .build();
		 * System.out.println("Before hover: "); mouseOverSettings.perform();
		 * System.out.println("First Hover done"); //Actions action=new
		 * Actions(driver);
