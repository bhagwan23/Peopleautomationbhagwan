...
public class AddRolesOfUserTest extends DriverFactory{
	...
	public void addRolesOfUserTest() throws InterruptedException {
		...
		homePage.clickSettingTab();
		homePage.clickUsersTab();
		usersPage.verifyPageTitle();
		usersPage.verifyUsersPageElements();
		usersPage.clickAddUserButton();
		usersPage.verifyAddUserPageElements();
		usersPage.enterUserDetails(firstName, lastName, emailid, passWord, phoneNumber);
