...
import java.awt.AWTException;
	...
	public class BOMProductimportPage {
		private WebDriver driver;
		private WebDriverWait wait;
		private SoftAssertListner sAssert;

		public BOMProductimportPage(WebDriver driver, WebDriverWait wait) {
			this.driver = driver;
			this.wait = wait;
		...
		public void selectTrackedProductobjecttoimpot() throws AWTException {
			sAssert.assertTrue(wait.until(ExpectedConditions.elementToBeClickable(BomProductsSelection)) != null,"Verify object selection to import");
			BomProductsSelection.click();
