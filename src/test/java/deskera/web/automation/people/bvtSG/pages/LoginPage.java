...
public class LoginPage {
	 ...
	 *******************/
	@FindBy(xpath = "//span[contains(.,'Deskera Bookkeeper')]")
...
//	@FindBy(xpath = "//span[contains(text(),'Deskera Books')]/../preceding-sibling::div[@class='card-background-img']")
	...
	@FindBy(xpath = "//span[contains(.,' Deskera People ')]")
	private WebElement goToDeskeraPeopleCard;
...
/*
	...
	*/
	@Step("Go to Deskera people")
	public void goToDeskerapeople() throws InterruptedException {
		Thread.sleep(3000);
		WDWait(goToDeskeraPeopleCard);
		wait.until(ExpectedConditions.elementToBeClickable(goToDeskeraPeopleCard));
		WDWaitClickable(goToDeskeraPeopleCard);
		Thread.sleep(3000);
		MOverElement(goToDeskeraPeopleCard);
		goToDeskeraPeopleCard.click();
		//Thread.sleep(3000);
	...
	@Step("ClickS On signIn Using Google")
